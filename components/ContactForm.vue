...
function validateField(field: keyof ContactFormValues) {
...
async function submit() {
  ...
  try {
    await $fetch('/api/contact', {
      method: 'POST',
      body: { ...form, message: form.message.trim() },
    })
    success.value = true
    resetForm()
    clearErrors()
...
<template>
  <div id="contact" class="overflow-hidden max-w-6xl max-lg:max-w-2xl mx-auto py-16 sm:py-24">
    <div class="grid lg:grid-cols-2 items-center gap-8">
        ...
        <form @submit.prevent="submit" novalidate>
          <div class="space-y-4 mt-8">
            <input
              ...
              type="text"
              placeholder="Имя"
              class="px-4 py-3 bg-white text-slate-900 rounded-md w-full text-sm border focus:border-gray-900 outline-0 transition-colors"
            ...
            <textarea
              ...
              rows="5"
              class="px-4 pt-3 bg-white text-slate-900 rounded-md w-full text-sm border focus:border-gray-900 outline-0 transition-colors"
      ...
      <div class="z-10 relative h-full max-lg:min-h-[400px] rounded-3xl overflow-hidden">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d823.1777888068161!2d26.862066586356768!3d54.29867679607751!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46dc753ddbe580b5%3A0xcff0afbcd988af52!2z0JzQtdCz0LDRhdC10L3QtA!5e0!3m2!1sru!2sby!4v1763653800367!5m2!1sru!2sby"
          width="600"
          height="450"
          style="border: 0"
          allowfullscreen
