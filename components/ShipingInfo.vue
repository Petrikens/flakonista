<template>
  <div id="shiping" class="bg-gray-100">
    <div
      ...
      <div>
        ...
        <dl class="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8">
          <div class="border-t border-gray-200 pt-4">
            ...
            <dd class="mt-2 text-sm text-gray-500"><b>Сроки:</b> 2–4 дня.</dd>
            <dd class="mt-2 text-sm text-gray-500">
              <b>Оплата:</b> Наличными или картой в отделении связи при получении.
            </dd>
            <dd class="mt-2 text-sm text-gray-500">
              <b>Важно:</b> При выдаче посылки почта взимает собственную комиссию за денежный
              перевод в размере 3% от суммы наложенного платежа.
            </dd>
          </div>
          <div class="border-t border-gray-200 pt-4">
            ...
            <dd class="mt-2 text-sm text-gray-500"><b>Сроки:</b> 2–4 дня.</dd>
            <dd class="mt-2 text-sm text-gray-500">
              <b>Оплата:</b> Наличными или картой в пункте выдачи.
            </dd>
            <dd class="mt-2 text-sm text-gray-500">
              <b>Важно:</b> При выдаче посылки почта взимает собственную комиссию за денежный
              перевод в размере 1,5% от суммы наложенного платежа.
            </dd>
          </div>
        </dl>
      </div>
